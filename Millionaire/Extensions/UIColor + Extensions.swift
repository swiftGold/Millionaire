...
extension UIColor {
    ...
    static let redLineColor = #colorLiteral(red: 0.8078431373, green: 0.05490196078, blue: 0.05490196078, alpha: 1)
    static let promptBorderColor = #colorLiteral(red: 0.1058823529, green: 0.5333333333, blue: 0.8980392157, alpha: 1)
    static let startLabelsColor = #colorLiteral(red: 0.3254901961, green: 0.8823529412, blue: 0.6470588235, alpha: 1)
}
